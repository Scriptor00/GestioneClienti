...
namespace GestioneClienti.Controllers
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        public PaymentController(IConfiguration configuration, ILogger<PaymentController> logger, IEmailSender emailSender /*, IOrderService orderService */)
        {
        ...
        public async Task<IActionResult> ProcessPayment([FromBody] PaymentRequest request)
        {
            ...
            var chargeOptions = new ChargeCreateOptions
            {
                ...
                // Puoi aggiungere qui metadata come l'ID dell'utente o dell'ordine
                // Metadata = new Dictionary<string, string> { { "order_id", "123" }, { "user_id", "456" } },
            };
